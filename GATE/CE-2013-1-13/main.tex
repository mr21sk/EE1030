...
\end{multicols}
\end{enumerate}
\item The pin-jointed 2-D truss is loaded with a horizontal force $15$ kN at joint $S$ and another $15$ kN vertical force at joint $U$ , as shown .Find the force in member $RS$ \brak{in \, \, kN} and report your answer taking trnsion as positive and compression as negative   . \rule{2cm}{0.4pt} \\ 
\begin{figure}[!ht]
\centering
