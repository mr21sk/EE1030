...
\end{multicols}
\end{enumerate}
\item A continuous random variable $X$ has a probability density function $f(x) = e^{-x}, \; 0 < x < \infty$. Then $P\cbrak{ X > 1 }$ is
\begin{enumerate}
\begin{multicols}{4}
\item $0.368$
\item $0.5$
...
\begin{enumerate}
\item $4xy \, \mathbf{a}_x + 6yz \, \mathbf{a}_y + 8zx \, \mathbf{a}_z$
\item $4 \, \mathbf{a}_x + 6 \, \mathbf{a}_y + 8 \, \mathbf{a}_z$
\item $\brak{4xy + 4z^2} \mathbf{a}_x + \brak{2x^2 + 6yz} \mathbf{a}_y + \brak{3y^2 + 8zx} \mathbf{a}_z$
\item $0$
\end{enumerate}
